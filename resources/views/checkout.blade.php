...
<h2>Online Purchase with Jazzcash</h2>
</div>
...
<form action="/checkout" method="POST" id="myCCForm">
    ...
    <input type="text" name="fullname" id="fullname" value="Zahid" class="form-control form-control-sm" > 
    </div></div>
    
    <div class="col-sm-6"><div class="form-group"> 
    <label for="email" class="small text-muted mb-1">
    <i class="fa fa-envelope"></i> Email</label> 
    <input type="text" name="email" id="email" value="zahidjakhar2370@gmail.com" class="form-control form-control-sm" > 
    </div></div>
    ...
    <input type="text" name="address" id="address" value="Layyah" class="form-control form-control-sm" > 
    </div></div>
    ...
    <input type="text" name="city" id="city" value="Layyah" class="form-control form-control-sm" > 
    </div></div>
    ...
    <div class="row mb-md-5">
        <div class="col"> 
        <button type="submit" name="" id="" class="btn btn-lg btn-block btn-primary">PURCHASE 20 PKR</button></div>
    </div>
</form>
<!-- ----------------------------------------------------------------------------------------- -->
<!-- ./payment form -->
